...
fn status_response(s: &ServerState) -> String {
    format!(
        "{{\"ok\":true,\"uptime_secs\":{:.3},\"episodes_planned\":{},\"applications\":{},\"global_words\":{},\"commits\":{},\"process_spawns\":{},\"tcp_requests\":{},\"ipc_requests\":{},\"timer_events\":{},\"web_requests\":{},\"mutation_candidates\":{},\"mutations_committed\":{},\"watched_tasks\":{},\"shadow_evaluations\":{},\"app_tasks\":{},\"app_actions\":{}}}",
        ...
        s.executor.watched_tasks,
        s.executor.shadow_evaluations,
        s.executor.app_tasks,
        s.executor.app_actions,
    )
}
...
fn metrics_response(s: &ServerState) -> String {
    format!(
        "{{\"ok\":true,\"episodes_planned\":{},\"applications\":{},\"global_words\":{},\"commits\":{},\"process_spawns\":{},\"tcp_requests\":{},\"ipc_requests\":{},\"web_requests\":{},\"mutation_candidates\":{},\"mutations_committed\":{},\"watched_tasks\":{},\"shadow_evaluations\":{},\"app_tasks\":{},\"app_actions\":{}}}",
        s.episodes_planned,
        s.registry.application_ids().len(),
        s.registry.global.vocab.derived.len(),
        s.executor.commits,
